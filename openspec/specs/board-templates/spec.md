...
## Purpose
Reusable board templates that users can save from existing boards, browse by category, and use to create new boards instantly — an alternative creation path alongside AI generation. Supports public/private visibility, system-managed categories, and full board structure snapshots (tasks, dependencies, subtasks).
